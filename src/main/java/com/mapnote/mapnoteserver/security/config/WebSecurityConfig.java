...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http
        ...
        .antMatchers(HttpMethod.GET, "/api/v1/users", "/api/v1/schedule").hasAnyRole("USER")
        .antMatchers(HttpMethod.PUT, "/api/v1/users/newPassword", "/api/v1/users").hasAnyRole("USER")
        .antMatchers(HttpMethod.DELETE, "/api/v1/users").hasAnyRole("USER")
        .and()
        .exceptionHandling()
